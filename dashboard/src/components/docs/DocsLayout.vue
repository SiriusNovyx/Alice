      ...
      return [
        ...
        },
        {
          ...
          items: [
            ...
            { to: "/docs/setup-guides/aio-plugins", label: "AIO plugins", icon: "·" },
            { to: "/docs/setup-guides/voicemaster", label: "VoiceMaster", icon: "·" },
            { to: "/docs/setup-guides/tickets", label: "Tickets", icon: "·" },
            { to: "/docs/setup-guides/giveaways", label: "Giveaways", icon: "·" },
            { to: "/docs/setup-guides/leveling", label: "Leveling", icon: "·" },
            { to: "/docs/setup-guides/verify", label: "Verify", icon: "·" },
            { to: "/docs/setup-guides/fun-social", label: "Fun & Social", icon: "·" },
            { to: "/docs/setup-guides/modmail", label: "Modmail", icon: "·" },
            { to: "/docs/setup-guides/antinuke", label: "AntiNuke", icon: "·" },
            { to: "/docs/setup-guides/economy", label: "Economy", icon: "·" },
            { to: "/docs/setup-guides/music", label: "Music", icon: "·" },
            { to: "/docs/setup-guides/collection-nsfw-booster", label: "Collection / Nsfw / Booster", icon: "·" },
          ],
        },
        {
          label: "Plugins",
