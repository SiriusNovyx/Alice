...
import { actualMassAddRoleCmd } from "./actualMassAddRoleCmd.js";

export const MassAddRoleCmd = rolesCmd({
  trigger: "massaddrole",
  usage: "!massaddrole <role> [user] [user] ...",
  ...
  async run({ message: msg, args, pluginData }) {
    ...
    await actualMassAddRoleCmd(pluginData, msg, authorMember, msg.author, role, args.members);
  },
});
